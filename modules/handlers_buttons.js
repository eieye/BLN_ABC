...
// ##MEMO## (RE CANCEL ANIMATIONS)
		// ANIMATE_GLYPH/ANMATION_VORSCHRIFT (IN "WATCH") ##507## ANIMATE_DOT/ANIMATION_KARAOKEDOT (IN "QUIZ") ##735##');
// ##TBD## (USABILITY) SET MARKER/HILITE ON CURRENTLY SELECTED BUTTON
		// (STATE UNCLEAR FOR USER AT LAUNCH AND AFTER STEPPER/POFO/QUIZ)
// ##MEMO## "CLEARDRAWING" DOES NOT INCLUDE ANIMATION // BUILD NEW COMMON FUNCTION "RESET/CANCEL ANIMATION"

// 050325 // ADDED ALERT ON SAVE BTN // EDITED AND ADDED VARIOUS HELP TEXTS IN ALERTS)
// 100325 // MORE HELP TEXTS AND EXPLANATIONS 
// 110325 // USING TEMP CASE-TOGGLE FROM "FULL ALPHA"
...
// 230325	// MSG WITH DISMISS ("DONT SHOW AGAIN") // INIT @LINE ##119##



// WIRE BUTTONS           // LINE ##154##
// (TOP) NAVIGATION
		// BTN HOME						// LINE ##328##
					// HOME MSG 		// LINE ##345##
		// BTN WATCH					// LINE ##439##
		...
		// BTN QUIZ           // LINE ##609##
		// BTN STEPPER
					// STEPPER MSG  // LINE ##799##
		// BTN PORTFOLIO			// LINE ##865##
					// POFO MSG  		// LINE ##885##
// (BOTTOM) NAVIGATION
    // BTN SAVETRACE      // LINE ##951##
    // BTN UCLC           // LINE ##994##
					// TOGGLE CASE  // LINE ##1008##
// *CLEARDRAWING*         // LINE ##1128##
// MODULE OVERLAY
    // RECORDERPLAYER     // LINE ##1218##
...
// SET "DO"
		...
		animateGlyph(); //###507###																																		// (IMPORTED FROM ANIMATION_VORSCHRIFT)
...
// ––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
var repeatanimation = function(e) {
	e.preventDefault();
...
// --MSG---
// INSERT INNER_HTML CUSTOM OVERLAY (USING MSGCONTAINER) FOR PLACEHOLDER "PORTFOLIO"
// LINK #TEMP# TO "EI-MOVIE" // LINE ##885##
	let alertpofo =`
			<div>
...
// SAVE TOGGLE-PAIR // (CAN BE "ASYMMETRIC" ALT-GLYPH/REGULAR)
		let upperglyph;
		let lowerglyph;
		let TOGGLE = [ upperglyph, lowerglyph ]; // TOGLE-PAIR // LINE ##1008##
